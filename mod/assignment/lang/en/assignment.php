...
$string['feedbackmostlyupdated'] = 'With the exception of the above errors, submissions feedback has been saved';
$string['fileuploaderror'] = 'There was a problem uploading the file: {$a}';
$string['filenotuploaded'] = 'The file {$a} was not an uploaded file';
...
$string['nosubmissionobject'] = 'The system was unable to find (or create) an appropriate submission object';
...
$string['quickgrade_response_files'] = 'Allow response files to be uploaded during quick grading';
$string['quickgrade_response_files_help'] = 'If this and "'. $string['quickgrade'] . '"are enabled, you will see a column that will allow you to upload response files when you click the "Save all my feedback" button (which will save all changes for that page).';
$string['requiregrading'] = 'Require grading';
$string['responsefilecolumnheader'] = "Response File";
